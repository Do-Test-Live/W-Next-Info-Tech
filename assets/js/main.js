...
let $video = $('#video-section video'),
    videoSrc = $('source', $video).attr('src', "assets/images/background.mp4");
...
window.setInterval(async function () {
    ...
    document.getElementById('ai').style.background = random_color.substring(0, 7);
    ...
    document.getElementById('ai-chat-1').style.background = random_color.substring(0, 7);
