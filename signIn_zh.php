          ...
          <a class="navbar-brand" href="https://www.facebook.com/ngttechio"
                ...
                <div class="collapse navbar-collapse container" id="main_nav">
                    <ul class="navbar-nav ms-auto" style="margin-right: 65px">
                        <li class="nav-item"><a class="nav-link text-white" href="home-zh#about"> 關於 NGT </a></li>
                        <li class="nav-item"><a class="nav-link text-white" href="home-zh#service"> 服務 </a></li>
                        <li class="nav-item"><a class="nav-link text-white" href="home-zh#start"> 開始 </a></li>
                        <li class="nav-item"><a class="nav-link text-white" href="home-zh#start"> 認證與審計 </a></li>
                        <li class="nav-item"><a class="nav-link text-white" href="home-zh#ngtPass"> NGT 通行證 </a></li>
                        <li class="nav-item"><a class="nav-link text-white" href="home-zh#press"> 新聞媒體 </a></li>
                        <li class="nav-item"><a class="nav-link text-white" href="signin" style="text-shadow: #fff 0px 0px 5px, #fff 0px 0px 10px, #004303 0px 0px 15px, #004703 0px 0px 20px, #068e0c 0px 0px 30px, #000601 0px 0px 40px, #213422 0px 0px 50px, #000000 0px 0px 75px;"> 搶先體驗 </a></li>
                        <li class="nav-item"><a class="nav-link text-white" href="login"> ENG </a></li>
    ...
    <section id="body">
        <section class="text-white pt-md-5 pb-md-5 pt-3 pb-5">
            <div class="container h-100 pt-md-5 pb-md-5 mb-5 pb-5" style="padding-bottom:10rem !important;">
                <div class="row d-flex justify-content-center align-items-center h-100 mb-5 pb-5">
                                        ...
                                        <form action="" class="mx-1 mx-md-4" method="post">
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0 me-4">
                                                    <input class="form-control" id="form3Example3c" name="email"
                                                           required type="email"/>
                                                    <label class="form-label content-paragraph" for="form3Example3c">進入</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0 me-4">
                                                    ...
                                                    <label class="form-label content-paragraph" for="form3Example1c">密碼</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class=" mb-4 text-center">
                                                沒有賬戶&nbsp;<a class="text-white fw-bold"
                                                                               href="register.html">註冊</a>
                                            </div>
